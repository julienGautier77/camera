...
class CAMERA(QWidget):
    ...
    def setup(self):  
            ...
            if self.light==False:
                ...
                self.visualisation=SEE2(confpath=self.confPath,name=self.nbcam) ## Widget for visualisation and tools  self.confVisu permet d'avoir plusieurs camera et donc plusieurs fichier ini de visualisation
