...
from PyQt5.QtWidgets import QVBoxLayout,QHBoxLayout,QPushButton,QGridLayout,QDoubleSpinBox,QSpinBox,QToolButton
...
#        self.setWindowTitle(nomWin+' : '+'                     V.'+str(self.version))
    ...
    def setup(self):
        ...
        self.haut.setStyleSheet("QToolButton:!pressed{border-image: url(./Iconeslolita/flechehaut.png);background-color: transparent ;border-color: green;}""QPushButton:pressed{image: url(./IconesLolita/flechehaut.png);background-color: transparent ;border-color: blue}")
        self.haut.setMaximumHeight(size)
        self.haut.setMinimumWidth(size)
        self.haut.setMaximumWidth(size)
        self.haut.setMinimumHeight(size)
        self.haut.setAutoRepeat(True)
        
        
        self.bas=QToolButton()
        self.bas.setStyleSheet("QToolButton:!pressed{border-image: url(./Iconeslolita/flechebas.png);background-color: transparent ;border-color: green;}""QPushButton:pressed{image: url(./IconesLolita/flechebas.png);background-color: gray ;border-color: blue}")
        self.bas.setMaximumHeight(size)
        self.bas.setMinimumWidth(size)
        self.bas.setMaximumWidth(size)
        self.bas.setMinimumHeight(size)
        self.bas.setAutoRepeat(True)
        
        self.gauche=QToolButton()
        self.gauche.setStyleSheet("QToolButton:!pressed{border-image: url(./Iconeslolita/flechegauche.png);background-color: transparent ;border-color: green;}""QPushButton:pressed{image: url(./IconesLolita/flechegauche.png);background-color: gray ;border-color: blue}")
        
        self.gauche.setMaximumHeight(size)
        self.gauche.setMinimumWidth(size)
        self.gauche.setMaximumWidth(size)
        self.gauche.setMinimumHeight(size)
        self.droite=QToolButton()
        self.droite.setStyleSheet("QToolButton:!pressed{border-image: url(./Iconeslolita/flechedroite.png);background-color: transparent ;border-color: green;}""QPushButton:pressed{image: url(./IconesLolita/flechedroite.png);background-color: gray ;border-color: blue}")
        self.droite.setMaximumHeight(size)
        self.droite.setMinimumWidth(size)
        self.droite.setMaximumWidth(size)
        self.droite.setMinimumHeight(size)
        ...
        self.jogStep.setMinimumHeight(20)
        ...
        self.position_Lat.setMaximumWidth(45)
        self.position_Lat.setMinimumHeight(20)
        self.position_Lat.setMinimumWidth(45)
        ...
        self.position_Vert.setMaximumWidth(45)
        self.position_Vert.setMinimumHeight(20)
        self.position_Vert.setMinimumWidth(45)
        ...
        self.zeroButtonLat.setMaximumHeight(20)
        self.zeroButtonVert.setMaximumHeight(20)
        self.zeroButtonLat.setMinimumHeight(20)
        self.zeroButtonVert.setMinimumHeight(20)
        
        self.zeroButtonLat.setMaximumWidth(38)
        self.zeroButtonVert.setMaximumWidth(38)
        self.zeroButtonLat.setMinimumWidth(38)
        self.zeroButtonVert.setMinimumWidth(38)
    ...
    def PositionLat(self,Posi):
        ...
        self.position_Lat.setText(str(round(a,1))) 
    ...
    def PositionVert(self,Posi): 
        ...
        self.position_Vert.setText(str(round(a,1))) 
...
if __name__ =='__main__':
    ...
    mot5=TILTMOTORGUI(motLat=motor0,motorTypeName0='RSAI',motVert=motor1,motorTypeName1='RSAI')
    mot5.show()
    mot5.startThread2()
    appli.exec_()
