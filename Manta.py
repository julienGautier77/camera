...
class CAMERA(QWidget):
    ...
    def setup(self):  
            ...
            """
            self.setWindowTitle('Visualization  '+ self.cameraType+ "vison"+"     " + self.ccdName+'    v.'+ self.version)
...
if __name__ == "__main__":       
    ...
    pathVisu='C:/Users/Salle-Jaune/Desktop/Python/camera/confCamera.ini'
    
    e = CAMERA(cam='cam1',fft='off',meas='on',affLight=False,aff='left',separate=False,multi=False,confpath=pathVisu)  
    e.show()
