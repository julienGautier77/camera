...
class ONEMOTORGUI(QWidget) :
    ...
    def __init__(self, IpAdress, NoMotor, nomWin='', showRef=False, unit=1, jogValue=100, parent=None):
        ...
        self.scanWidget=SCAN(MOT=self.MOT[0],parent=self) # for the scan
    ...
    def update(self):
        # update from the data base (RSAIdb To python soft)
        self.MOT[0].update()
    ...
    def updateDB(self):
        #  update the Data base (python soft to RSAI dB)
        i=1
