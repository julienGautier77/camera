...
class CAMERA(QWidget):
    ...
    def setup(self):  
            ...
            self.graphButton=QToolButton(self)
            self.graphButton.setText('Graph')
            hboxGraph.addWidget(self.graphButton)
            self.graphResetButton=QToolButton(self)
            self.graphResetButton.setText('Reset')
            hboxGraph.addWidget(self.graphResetButton)
            
            self.vbox1.addLayout(hboxGraph)
    ...
    def actionButton(self): 
        ...
        self.graphButton.clicked.connect(self.graphButtonAction)
        self.graphResetButton.clicked.connect(self.graphResetButtonAction)
    def oneImage(self):
        #self.nbShot=1
    ...
    def Display(self,data):
        ...
        if self.CAM.camIsRunnig==False:
            self.stopAcq()
        if self.graphXmax.isWinOpen==True or self.graphYmax.isWinOpen==True :
            self.graphButtonAction()
